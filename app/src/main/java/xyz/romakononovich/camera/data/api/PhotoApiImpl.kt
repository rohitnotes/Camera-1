 ...
 */
class PhotoApiImpl
@Inject constructor(private val context: Context) : PhotoApi {
    ...
    override fun getExif(path: String) {
        ...
        builder.append("${context.getString(R.string.dialog_info_height)}: ${exif.getAttribute(ExifInterface.TAG_IMAGE_LENGTH)}\n\n")
        builder.append("${context.getString(R.string.dialog_info_width)}: ${exif.getAttribute(ExifInterface.TAG_IMAGE_WIDTH)}\n\n")
